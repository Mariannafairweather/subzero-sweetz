...
import { useToast } from '@/components/ui/use-toast'
    ...
    const [uploadProgress, setUploadProgress] = useState<number>(60)
    ...
    return (
        <div
            className={cn(
                "relative h-full flex-1 my-16 w-full rounded-xl bg-grey-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl flex justify-center flex-col items-center",
                {
