...
function ReviewGrid() {
    ...
    grid h-[49rem] max-h-[150vh] grid-cols-1 items-start gap-8 overflow-hidden px:4 
...
export function Reviews() {
    return <MaxWidthWrapper className='relative max-w-5x1'>
        <img
            aria-hidden="true"
            src="/whatyb.png"
            className='absolute select-none hhidden xl:block -left-32 top-1/3'
        />
